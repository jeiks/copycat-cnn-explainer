<script>
  ...
  $: if (stride > 0) {
    ...
    let copycatstrideNumberInput = document.getElementById("copycatstrideNumber");
    if (Number.isInteger(stepSize)) {
      outputFinal = singleConv(input, kernel, stride);
      if (copycatstrideNumberInput != null) {
        copycatstrideNumberInput.className = copycatstrideNumberInput.className.replace("is-danger", "");
      }
      isStrideValid = true;
    } else {
      if (!copycatstrideNumberInput.className.includes("is-danger")) {
        copycatstrideNumberInput.className += " is-danger";
      }
      isStrideValid = false;
...
<div class="container has-text-centered" id="copycatdetailview-container">
  <div class="box">
      ...
      <div class="left-part">
        ...
        <div class="input-row">
          <div class="field is-horizontal">
            ...
            <input class="input is-very-small" type=number id="copycatstrideNumber" bind:value={stride} min=1
